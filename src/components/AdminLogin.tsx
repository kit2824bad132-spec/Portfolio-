...
export default function AdminLogin({ onLogin, onBack }: AdminLoginProps) {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-4 relative overflow-hidden transition-all duration-300 ${
      isDark ? 'bg-[#0a0a0f]' : 'bg-gradient-to-br from-slate-50 via-red-50 to-rose-50'
    }`}>
      {/* Background orbs */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-red-500/10 blur-[120px] animate-float" />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-rose-500/10 blur-[100px] animate-float" style={{ animationDelay: '2s' }} />
        <div className={`absolute top-0 right-0 w-1/2 h-1/2 ${isDark ? 'bg-red-950/20' : 'bg-red-100/30'} rounded-bl-full blur-3xl`} />
      </div>
      ...
      <div className={`relative w-full max-w-md rounded-3xl shadow-2xl overflow-hidden animate-fade-in-up ${
        ...
        {/* Top gradient bar */}
        <div className="h-1.5 bg-gradient-to-r from-red-600 via-rose-500 to-red-400" />

        <div className="p-8 sm:p-10">
          {/* Logo */}
          <div className="flex items-center gap-3 mb-8">
            <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-red-600 to-rose-500 flex items-center justify-center shadow-lg shadow-red-500/25">
          ...
          {/* Error */}
          {error && (
            <div className="flex items-start gap-2 mb-5 px-4 py-3 rounded-xl bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900 text-red-600 text-sm animate-fade-in-up">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className={`w-full pl-10 pr-4 py-3 rounded-xl text-sm transition-all focus:outline-none focus:ring-2 focus:ring-red-500/30 focus:border-red-500 ${
                    isDark
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className={`w-full pl-10 pr-12 py-3 rounded-xl text-sm transition-all focus:outline-none focus:ring-2 focus:ring-red-500/30 focus:border-red-500 ${
                    isDark
                      ? 'bg-[#1a1a28] border border-white/10 text-white placeholder-slate-600'
                      : 'bg-white border border-gray-200 text-gray-900 placeholder-gray-300'
                  }`}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 rounded-xl bg-gradient-to-r from-red-600 to-rose-500 text-white font-semibold text-sm
                hover:opacity-90 active:scale-[0.98] transition-all shadow-lg shadow-red-500/25
