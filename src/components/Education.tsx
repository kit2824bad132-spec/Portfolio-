...
export default function Education() {
  return (
    <section id="education" className="py-24 px-6 bg-orange-50/40">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          <div className="absolute left-6 top-0 bottom-0 w-px bg-gradient-to-b from-orange-400/50 via-orange-300/30 to-transparent" />
              ...
              return (
                <div key={i} className="relative pl-16">
                  <div className={`absolute left-0 w-12 h-12 rounded-xl border flex items-center justify-center ${
                    edu.current
                      ? 'bg-orange-50 border-orange-300 animate-pulse-glow'
                      : 'bg-white border-gray-200'
                  }`}>
                    <Icon size={20} className={edu.current ? 'text-orange-600' : 'text-gray-400'} />
                  </div>

                  <div className={`bg-white border rounded-2xl p-6 transition-all duration-300 hover:shadow-md ${
                    edu.current ? 'border-orange-200 hover:border-orange-300' : 'border-gray-100 hover:border-gray-200'
                  }`}>
                    ...
                    <div className="flex items-center gap-3">
                      {edu.current && (
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-orange-50 border border-orange-200 text-orange-600 text-xs font-medium">
